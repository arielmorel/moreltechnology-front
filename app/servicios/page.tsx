          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {services.map((service) => {
              ...
              return (
                <div
                  key={service.name}
                  className="bg-card rounded-2xl border border-border p-6 hover:shadow-lg hover:border-border transition-all duration-300 hover:-translate-y-1"
                >
      ...
      <section className="pb-16 px-4 md:px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-amber-500 to-amber-600 rounded-3xl p-8 md:p-12 text-center text-white">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-card text-amber-600 font-bold px-6 py-3 rounded-full hover:bg-amber-50 transition-colors"
          >
