    ...
    <div className="space-y-3">
      ...
      <div className="group relative">
        <div
          ...
          className="relative aspect-square md:aspect-[4/3] cursor-zoom-in rounded-2xl overflow-hidden bg-slate-50 touch-pan-y focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2"
