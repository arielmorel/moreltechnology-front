    ...
    <section className="py-16 md:py-24 bg-background overflow-hidden">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mb-10 md:mb-16">
          <div className="animate-slide-up inline-flex items-center gap-2 px-3 py-1 rounded-full bg-yellow-500/10 text-yellow-600 text-xs font-bold uppercase tracking-widest mb-4 md:mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 md:gap-8">
            ...
            <div className="animate-slide-up-delay-2 flex items-center gap-4 p-4 bg-muted/30 rounded-2xl border border-border/50 w-fit shrink-0">
              ...
              <CarouselItem key={review.id} className="pl-3 md:basis-1/2 lg:basis-1/3">
                <div className="animate-scale-in h-full p-5 md:p-7 bg-card border border-border/50 rounded-2xl md:rounded-3xl flex flex-col shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all group">
                  ...
                  <div className="mt-auto pt-4 md:pt-5 border-t border-border/50 flex items-center gap-3">
                    <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-sm md:text-base shrink-0">
